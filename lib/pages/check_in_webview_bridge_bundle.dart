...
''',
  ...
  static Map<String, dynamic> _buildUserinfoResult(
    ...
    final Map<String, dynamic> result = <String, dynamic>{
      ...
      'grbh': _firstNonEmpty(rawUserinfo['grbh'], bridgeContext['grbh']),
      'zjhm': _firstNonEmpty(rawUserinfo['zjhm'], bridgeContext['zjhm']),
      ...
      'jgbh': _firstNonEmpty(rawUserinfo['jgbh'], bridgeContext['jgbh']),
      'jgbm': _firstNonEmpty(rawUserinfo['jgbm'], bridgeContext['jgbm']),
      'zxbm': _firstNonEmpty(rawUserinfo['zxbm'], bridgeContext['zxbm']),
